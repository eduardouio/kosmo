# Generated by Django 4.2.14 on 2025-04-06 10:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num_invoice', models.CharField(blank=True, default='', max_length=50)),
                ...
                ('total_margin', models.DecimalField(decimal_places=2, default=0, max_digits=10, verbose_name='Margen total')),
                ('comision_seler', models.DecimalField(decimal_places=2, default=0, max_digits=10, verbose_name='Comisión Vendedor')),
                ...
                ('fb_total', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=10, null=True, verbose_name='Total FB')),
                ('total_pieces', models.PositiveSmallIntegerField(blank=True, default=0, null=True, verbose_name='Total Piezas')),
                ('tot_stem_flower', models.IntegerField(blank=True, default=0, null=True, verbose_name='Cantidad Total de Tallos')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hb_total', models.PositiveSmallIntegerField(default=0, verbose_name='Total HB')),
                ('fb_total', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=10, null=True, verbose_name='Total FB')),
                ...
                ('id_invoice', models.PositiveIntegerField(blank=True, default=0, null=True, verbose_name='Factura')),
                ('num_invoice', models.CharField(blank=True, default=None, max_length=50, null=True, verbose_name='No Factura')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('line_commission', models.DecimalField(decimal_places=2, default=0.0, max_digits=10, verbose_name='Comisión')),
                ...
                ('quantity', models.PositiveSmallIntegerField(default=0, verbose_name='Cant Cajas')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commission', models.DecimalField(decimal_places=2, default=0.0, max_digits=10, verbose_name='Comisión')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_user_updated', models.PositiveIntegerField(blank=True, default=0, help_text='Identificador del usuario actualizador del registro.', null=True, verbose_name='usuario actualizador')),
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('id_order_item', models.PositiveSmallIntegerField(blank=True, default=0, null=True, verbose_name='ID Item Orden')),
                ('box_model', models.CharField(choices=[('HB', 'HB'), ('QB', 'QB'), ('FB', 'FB')], max_length=50, verbose_name='Tipo de caja')),
                ('quantity', models.PositiveSmallIntegerField(default=0, verbose_name='Cant Cajas')),
                ('tot_stem_flower', models.IntegerField(default=0, verbose_name='Cantidad Tallos')),
                ('line_price', models.DecimalField(decimal_places=2, default=0.0, max_digits=10, verbose_name='Precio Linea')),
                ('line_margin', models.DecimalField(decimal_places=2, default=0.06, max_digits=5, verbose_name='Margen Linea')),
                ('line_total', models.DecimalField(decimal_places=2, default=0.0, max_digits=10, verbose_name='Precio Total')),
                ('line_commission', models.DecimalField(decimal_places=2, default=0.0, max_digits=10, verbose_name='Comisión')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profit_margin', models.DecimalField(decimal_places=2, default=0.06, max_digits=5, verbose_name='Margen de Ganancia')),
                ('commission', models.DecimalField(decimal_places=2, default=0.0, max_digits=10, verbose_name='Comisión')),
                ('total_bunches', models.IntegerField(blank=True, default=0, null=True, verbose_name='Total de ramos')),
                ('stems_bunch', models.IntegerField(blank=True, default=0, null=True, verbose_name='Cantidad de tallos por ramo')),
                ('invoice_item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='trade.invoiceitems')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.product')),
            ],
            options={
                'get_latest_by': 'created_at',
        ...
        migrations.CreateModel(
            name='HistoricalInvoiceBoxItems',
            fields=[
                ('notes', models.TextField(blank=True, default=None, help_text='Notas del registro.', null=True, verbose_name='notas')),
                ('created_at', models.DateTimeField(blank=True, editable=False, help_text='Fecha de creación del registro.', verbose_name='fecha de creación')),
                ('updated_at', models.DateTimeField(blank=True, editable=False, help_text='Fecha de ultima actualización del registro.', verbose_name='fecha de actualización')),
                ...
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('invoice_item', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='trade.invoiceitems')),
                ('product', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='products.product')),
            ],
            options={
                'verbose_name': 'historical invoice box items',
                'verbose_name_plural': 'historical invoice box itemss',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': ('history_date', 'history_id'),
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
