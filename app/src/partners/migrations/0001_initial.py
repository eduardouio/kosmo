# Generated by Django 4.2.14 on 2024-11-03 05:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cargo_reference', models.CharField(blank=True, help_text='Es el transportista que se usa para enviar la carga', max_length=255, null=True, verbose_name='Referencia de Carga')),
                ('type_partner', models.CharField(choices=[('CLIENTE', 'CLIENTE'), ('PROVEEDOR', 'PROVEEDOR')], max_length=50, verbose_name='Tipo de Socio')),
                ...
                ('partner', models.ManyToManyField(blank=True, help_text='proveedores a los que los clientes pueden comprar', to='partners.partner')),
            ],
            options={
                'ordering': ['-created_at'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_user_updated', models.PositiveIntegerField(blank=True, default=0, help_text='Identificador del usuario actualizador del registro.', null=True, verbose_name='usuario actualizador')),
                ('id', models.IntegerField(blank=True, db_index=True)),
                ('dae', models.CharField(db_index=True, max_length=50, verbose_name='DAE')),
            ...
            options={
                'verbose_name': 'historical dae',
                'verbose_name_plural': 'historical daes',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': ('history_date', 'history_id'),
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_type', models.CharField(choices=[('COMERCIAL', 'COMERCIAL'), ('FINANCIERO', 'FINANCIERO'), ('LOGISTICA', 'LOGÍSTICO'), ('OTRO', 'OTRO')], default='COMERCIAL', max_length=20, verbose_name='Tipo de Contacto')),
                ('phone', models.CharField(blank=True, max_length=20, null=True, verbose_name='Teléfono')),
                ('email', models.EmailField(blank=True, max_length=255, null=True, verbose_name='Correo Electrónico')),
